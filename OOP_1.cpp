...
void Menu(NhanVienSuaOngNuoc ds_nv_suaongnuoc[],NhanVienGiaoHang ds_nv_giaohang[],int n, int m)
{
	...
	while(1)
	{
		...
		else if(luachon==3)
		{
			...
			for(int i=0;i<n;i++){
				cout<<"Nhan vien SUA ONG NUOC thu "<<i+1<<":\n";
		...
		else if(luachon==4)
		{
			...
			for(int i=0;i<m;i++){
				cout<<"Nhan vien GIAO HANG thu "<<i+1<<":\n";
...
int main(){
	NhanVienSuaOngNuoc ds_nv_suaongnuoc[100]; //moi 1 gia tri trong mang la 1 class nhan vien
